<template>
    <main class="px-2 py-4 bg-white rounded-xl">
        <article class="my-class mx-2">
            <h1 class="font-semibold text-sm">Your Order</h1>
            <p class="text-[10px]">Judul Product yang dipilih</p>
        </article>

        <section class="mt-5 flex  justify-between items-center mx-2">
            <article>
                <h1 class="text-xs font-semibold">Jumlah paket</h1>
            </article>

            <main class="flex gap-5 items-center ">
                <button @click="ngurang" class="text-xl bg-white border-green-400 p-1 border w-full rounded-full">
                    <svg viewBox="0 -12 32 32" version="1.1" class="w-2 " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" fill="#0BBF04" stroke="#0BBF04"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>minus</title> <desc>Created with Sketch Beta.</desc> <defs> </defs> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage"> <g id="Icon-Set-Filled" sketch:type="MSLayerGroup" transform="translate(-414.000000, -1049.000000)" fill="#0BBF04"> <path d="M442,1049 L418,1049 C415.791,1049 414,1050.79 414,1053 C414,1055.21 415.791,1057 418,1057 L442,1057 C444.209,1057 446,1055.21 446,1053 C446,1050.79 444.209,1049 442,1049" id="minus" sketch:type="MSShapeGroup"> </path> </g> </g> </g></svg>
                </button>
                {{ hasil }}
                <button @click="nambah" class="text-xl bg-white border-green-400 p-1 border w-full rounded-full">
                    <svg viewBox="0 0 32 32" version="1.1" class="w-2 " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>plus</title> <desc>Created with Sketch Beta.</desc> <defs> </defs> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage"> <g id="Icon-Set-Filled" sketch:type="MSLayerGroup" transform="translate(-362.000000, -1037.000000)" fill="#0BBF04"> <path d="M390,1049 L382,1049 L382,1041 C382,1038.79 380.209,1037 378,1037 C375.791,1037 374,1038.79 374,1041 L374,1049 L366,1049 C363.791,1049 362,1050.79 362,1053 C362,1055.21 363.791,1057 366,1057 L374,1057 L374,1065 C374,1067.21 375.791,1069 378,1069 C380.209,1069 382,1067.21 382,1065 L382,1057 L390,1057 C392.209,1057 394,1055.21 394,1053 C394,1050.79 392.209,1049 390,1049" id="plus" sketch:type="MSShapeGroup"> </path> </g> </g> </g></svg>
                </button>
            </main>
        </section>

        <hr class="border mt-4 border-black rounded-full">

        <section class="">
            <form class="" >
                <section class="max-w-sm mx-auto grid grid-cols-2">
                    <main>
                        <label for="website-admin" class="block mt-8 mb-1 mx-2 text-[10px] font-medium text-gray-900 ">Nama Lengkap Pengirim</label>
                        <div class="flex mx-2">
                            <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-[#89BEA2] border border-e-0 border-gray-300 rounded-s-md ">
                            </span>
                    ...
                    <main>
                        <label for="website-admin" class="block mt-8 mb-1 mx-2 text-[10px] font-medium text-gray-900 ">No.Telp Pengirim</label>
                        <div class="flex mx-2">
                            <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-[#89BEA2] border border-e-0 border-gray-300 rounded-s-md ">
                            </span>
                            <input type="text" id="website-admin" class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  " placeholder="Bonnie Green">
                ...
                <div class="relative max-w-sm mx-5 justify-center mt-10">
                    <label  class="block mt-8 mb-1 mx-2 text-[10px] font-medium text-gray-900 ">Tanggal Jemput/ Pengiriman Paket</label>
                    <div class="absolute  flex items-center ps-3.5 pt-3 pointer-events-none">
                        <svg class="w-4 h-4 text-[#37c077]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z"/>
                        </svg>
                    </div>
                    <input datepicker type="text" id="tanggalan" name="tanggalan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 " placeholder="Select date">
                </div>
